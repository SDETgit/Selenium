	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Get methods 
		   ChromeDriver driver = new ChromeDriver();
			 ...
			 * 
			 * String Title = driver.getTitle(); System.out.println(Title); // String source
			 * = driver.getPageSource(); // System.out.println(source); String WinH =
		  ...
		  //Conditonal methods 
			 ...
			 * 
			 * boolean logo =
			 * driver.findElement(By.xpath("//*[text()='ArtOfTesting']")).isDisplayed();
			 * System.out.println(logo); boolean enab=
			 * driver.findElement(By.xpath("//*[@id='fname']")).isEnabled();
			 ...
			 * 
			 * boolean radiobox =
			 * driver.findElement(By.xpath("//*[@value='male']")).isSelected();
			 * System.out.println("Status of radiobox male:- " +radiobox); boolean radiobox2
			 * = driver.findElement(By.xpath("//*[@value='female']")).isSelected();
			 * System.out.println("Status of radiobox female:- " +radiobox2); WebElement
			 * aut_check=
			 * driver.findElement(By.xpath("//*[@value=\"Automation\" and @type='checkbox']"
			 * ));
			 * 
